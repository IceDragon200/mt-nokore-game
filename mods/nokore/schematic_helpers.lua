...
--
-- @spec nokore.schematic_helpers.from_y_slices(YSliceSchematic) :: Schematic
...
function ic:to_schematic()
  ...
  return nokore.schematic_helpers.from_y_slices(y_slice_schematic)
end

nokore.schematic_helpers.Builder = Builder

--
-- Creates a new builder instance
--
-- @spec nokore.schematic_helpers.build() :: Builder
function nokore.schematic_helpers.build()
  return nokore.schematic_helpers.Builder:new()
end
